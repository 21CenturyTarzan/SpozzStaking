...
import GraphikOff from "../assets/fonts/GraphikRegular.otf";
...
const graphik = {
  ...
  src: `
		...
		url(${GraphikOff}) format('otf')
	`,
};


const fonts = [square, squareLight, squareMedium, squareBold, squareItalic, graphik];
