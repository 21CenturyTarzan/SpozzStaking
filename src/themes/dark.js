...
const darkTheme = {
  ...
  background: `
    ...
    `,
  paperBg: "rgba(54, 56, 64, 0.0)",
  modalBg: "#24242699",
  popoverBg: "rgba(54, 56, 64, 0.99)",
  menuBg: handleBackdropFilter("rgba(54, 56, 64, 0.0)"),
  backdropBg: "rgba(54, 56, 64, 0.0)",
  ...
  secondaryButtonHoverBG: "rgba(255, 56, 64, 1)",
  outlinedPrimaryButtonHoverBG: "#F8CC82",
  outlinedPrimaryButtonHoverColor: "#333333",
  outlinedSecondaryButtonHoverBG: "transparent",
  outlinedSecondaryButtonHoverColor: "#F8CC82", //gold
  containedSecondaryButtonHoverBG: "rgba(255, 255, 255, 0.2)",
  ...
  createTheme(
    {
      ...
      overrides: {
        ...
        MuiButton: {
          ...
          containedPrimary: {
            color: "white",
            background: "linear-gradient(90deg, #4786D6 37.02%, #42DACE 100%)",
            padding: "25px",
            paddingBottom: "30px",
            width: "200px",
